...
<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <?php include('function/loading/tambahloading.php'); ?></div>
						<br><a href="index.php?halaman=dataloun" class="btn btn-success"><i class="fa fa-arrow-circle-left"></i> Kembali</a><br>
                        </br>
...
<table class="table table-striped table-bordered table-hover" id="dataTables-example">
    <thead>
        <tr bgcolor="#f2f2f2">
			...
			<th style='min-width:10px; vertical-align:middle' rowspan="3">Aksi</th>
        </tr>
		<tr bgcolor="#f2f2f2">
...
if(ISSET($_GET['data']))
{
	$conditions = "  and load_unload.Id_LO='".$_GET['id']."'  AND (Tanggal LIKE '%".$_GET['data']."%')";
        ...
        <tr align="center">
            ...
            <td>
                <a href="index.php?halaman=ubahdataloading&Id_Loun=<?php echo $data['Id_Loun'] ;?>" class="btn btn-default"><i class="fa fa-edit"></i> Ubah</a>
                <a href="index.php?halaman=hapusloading&Id_Loun=<?php echo $data['Id_Loun']; ?>&Id_LO=<? echo $data['Id_LO'];?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
            </td>
        </tr>
        <?php
    }
...
<td align='center' colspan="2" bgcolor="#f2f2f2"><b><?php echo $blank ; ?></b></td>	
        </tr>
    </tbody>
</table>
</form>     
