...
<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <a href="index.php?halaman=tambahloun" class="btn btn-primary"><i class="fa fa-share-square-o"></i> Tambah Loading-Unloading</a>
                        </br></br>
...
<th><small>OK</small></th></tr>
    ...
    <tbody>
        ...
        if(isset($_POST['button'])){
            ...
            $us = mysql_query("SELECT * FROM loun JOIN user ON loun.Id_User = user.Id_User JOIN produk ON loun.Id_Produk = produk.Id_Produk order by Id_LO");
        }
        ...
        <tr>
            ...
            <td>
                <a href="index.php?halaman=dataloading&id=<?php echo $data['Id_LO'] ;?>&id2=<?php echo $data['Tanggal']; ?>" class="btn btn-default"><i class="fa fa-play-circle"></i> Detail</a>
				<a href="index.php?halaman=inputtotal&Id_LO=<?php echo $data['Id_LO'] ;?>" class="btn btn-success"><i class="fa fa-edit"></i> Total</a>
            </td>
        </tr>
        <?php
    }
