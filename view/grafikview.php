...
<a href="index.php?halaman=tambahnote&tgl_awal=<?php echo $_POST['tgl_awal']; ?>
&tgl_akhir=<?php echo $_POST['tgl_akhir']; ?>" class="btn btn-danger"><i class="fa fa-edit"></i> Buat Note Saran</a>

                        <div class="panel-body">
                        
<body>
<div class="panel panel-default"><div class="panel-heading" align="left">Cat: Apabila Persentase NG > 3% Lakukan Pembuatan Note Saran Kebijakan Produksi</div></div>
