...
<a href="javascript:void(0);" class="btn btn-default" plain="true" onclick="window.open('cetak-loun-sub.php?dt1cari=<?php echo $_POST['dt1cari']; ?>
&dt2cari=<?php echo $_POST['dt2cari']; ?>
','Laporan Pemeliharaan','size=800,height=800,scrollbars=yes,resizeable=no')"><i class="fa fa-print"></i> CETAK</a>
...
<th><small>OK</small></th></tr>
    ...
    ?>
	<tr align="right">
        <td colspan='6' bgcolor="#f2f2f2"><b>Sub Total</b></td>
        <td  bgcolor="#f2f2f2"><b><?php echo $total_t ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_l ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_m ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_k ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_s ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_b ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_n ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_o ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $blank ; ?></b></td></tr>
	<?php
$total_t2=0;
$total_m2=0;
$total_k2=0;
...
$total_o2=0;
	...
	<tr align="right">
        <td colspan='6' bgcolor="#f2f2f2"><b>Sub Total</b></td>
        <td  bgcolor="#f2f2f2"><b><?php echo $total_t2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_l2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_m2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_k2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_s2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_b2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_n2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_o2 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $blank ; ?></b></td></tr>
		<?php
$total_t3=0;
$total_m3=0;
...
$total_o3=0;
        ...
        <tr>
			...
			<td><?php echo $data['Total_Kotor'] ?></td>
			<td><?php echo $data['Total_Serabut'] ?></td>
			<td><?php echo $data['Total_Bintik'] ?></td>			<td><?php echo $data['Total_NG'] ?></td>
			<td><?php echo $data['Total_OK'] ?></td>
			<?php if($data['Status'] == "Menunggu Persetujuan") {echo "<td align='center' bgcolor='#FFCC66'><strong>Menunggu Persetujuan</strong></td>";} 
												else if($data['Status'] == "Disetujui") {echo "<td align='center' bgcolor='#66CCCC'><strong>Disetujui</strong></td>";} ?>
        </tr>
	...
	<tr align="right">
        <td colspan='6' bgcolor="#f2f2f2"><b>Sub Total</b></td>
        <td  bgcolor="#f2f2f2"><b><?php echo $total_t3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_l3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_m3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_k3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_s3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_b3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_n3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $total_o3 ; ?></b></td>
		<td  bgcolor="#f2f2f2"><b><?php echo $blank ; ?></b></td></tr>
    </tbody>
</table>
</form>     
